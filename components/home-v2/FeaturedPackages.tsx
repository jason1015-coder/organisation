  ...
  return (
    <section className="py-12 md:py-24 px-4 md:px-6 container mx-auto">
      <div className="mb-8 sm:mb-16 border-b border-black pb-4 sm:pb-8">
        ...
        <p className="text-xs sm:text-lg text-black/70 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-black p-8 group hover:bg-[#FAFAFA] transition-colors flex flex-col h-full">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="hidden sm:block font-mono text-xs font-bold bg-[#0000EE]/10 text-[#0000EE] px-3 py-1 uppercase tracking-wider">
              TypeScript
            </span>
          </div>
          <p className="text-sm sm:text-lg text-black/70 leading-relaxed mb-8 flex-grow">
