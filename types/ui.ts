...
export const themes: Record<ThemePreset, Theme> = {
  ...
  "gruvbox-light": {
    ...
    colors: {
      ...
      diffAdded: "#e8e5c0",
      diffRemoved: "#f0d5d5",
      diffAddedText: "#79740e",
      diffRemovedText: "#9d0006",
    },
  },
  "solarized-dark": {
    name: "solarized-dark",
  ...
  "ayu-mirage": {
    ...
    colors: {
      ...
      diffAdded: "#2d3d2d",
      diffRemoved: "#3d2d2d",
      diffAddedText: "#bae67e",
      diffRemovedText: "#f28779",
    },
  },
  "ayu-light": {
    name: "ayu-light",
