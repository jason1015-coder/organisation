            ...
            <div className="space-y-4 sm:space-y-8 lg:pr-8">
              ...
              <StaggerItem>
                <p className="text-sm sm:text-lg sm:text-xl text-foreground/70 max-w-[540px] leading-relaxed">
                  ...
                  models on Apple Silicon. No YAML configs, no complex flags -
                  ...
                  <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-foreground/20 border border-foreground/20">
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Optimized for MLX to leverage unified memory
                          architecture, delivering blazing fast local
                          fine-tuning on Mac.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          No complex YAML configs or endless CLI flags. A clean,
                          interactive interface guides you through every step.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Automatically handles dataset validation, ChatML
                          formatting, training loops, and LoRA fusion.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Validate model performance with integrated LLM judge
                          and benchmarking suites directly from the CLI.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Export your tuned models to standard GGUF format for
                          direct use in Ollama, LM Studio, or llama.cpp.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Test your fine-tuned models immediately via the
                          built-in chat interface. No external tools required.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background p-8 space-y-4 hover:bg-muted transition-colors h-full">
                        ...
                        <p className="text-sm text-foreground/70 leading-relaxed">
                          Train models entirely offline. Your proprietary
                          datasets never leave your machine.
                        </p>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background border border-foreground/20 p-8 group transition-all flex flex-col h-full relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col h-full gap-4">
                          ...
                          <p className="text-foreground/70 font-mono text-sm leading-relaxed">
                            Built specifically for M-series chips to maximize
                            training efficiency using MLX.
                          </p>
                        </div>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background border border-foreground/20 p-8 group transition-all flex flex-col h-full relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col h-full gap-4">
                          ...
                          <p className="text-foreground/70 font-mono text-sm leading-relaxed">
                            Export your models to universally supported formats.
                            Your workflow remains entirely yours.
                          </p>
                        </div>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background border border-foreground/20 p-8 group transition-all flex flex-col h-full relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col h-full gap-4">
                          ...
                          <p className="text-foreground/70 font-mono text-sm leading-relaxed">
                            Fine-tune on sensitive company data without fear of
                            leaks or API terms of service changes.
                          </p>
                        </div>
                      </CardHover>
                    </StaggerItem>
                    ...
                    <StaggerItem>
                      <CardHover className="bg-background border border-foreground/20 p-8 group transition-all flex flex-col h-full relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col h-full gap-4">
                          ...
                          <p className="text-foreground/70 font-mono text-sm leading-relaxed">
                            Seamlessly integrates with the broader MLX and
                            llama.cpp ecosystems for advanced use cases.
                          </p>
                        </div>
                      </CardHover>
                    </StaggerItem>
                  ...
                  {["a", "b"]
                    .slice(
                      ...
                      Math.max(
                        0,
                        2 -
                          allSponsors.filter((s) => s.name !== "Atlas Cloud")
                            .length,
                      ),
                    )
                    .map((slot) => (
...
export const getStaticProps: GetStaticProps<NanotunePageProps> = async () => {
  ...
  try {
    ...
    const repoRes = await fetch(
      "https://api.github.com/repos/Nano-Collective/nanotune",
      { headers },
    );
    if (repoRes.ok) {
    ...
    const releasesRes = await fetch(
      "https://api.github.com/repos/Nano-Collective/nanotune/releases?per_page=100",
      { headers },
    );
    if (releasesRes.ok) {
    ...
    const contributorsRes = await fetch(
      "https://api.github.com/repos/Nano-Collective/nanotune/contributors?per_page=100",
      { headers },
    );
