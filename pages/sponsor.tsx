              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {builderSponsors.map((sponsor) => (
                    <div key={sponsor.name} className="relative group overflow-hidden border border-foreground/20 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgb(0,0,0,0.5)] transition-all">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {projects.map((project) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden block border border-foreground/20 bg-background p-6 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgb(0,0,0,0.5)] transition-all"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 dark:opacity-100 pointer-events-none" />
            ...
            <div className="max-w-5xl mx-auto space-y-12">
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                {tiers.map((tier) => (
                  <div
                    key={tier.name}
                    className="relative group flex flex-col h-full bg-background border border-foreground/20 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgb(0,0,0,0.5)] transition-all overflow-hidden"
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 dark:opacity-100 pointer-events-none" />
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto space-y-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-foreground/10 justify-center">
                <a
                  href="https://opencollective.com/nano-collective"
                  target="_blank"
                  rel="noopener noreferrer"
